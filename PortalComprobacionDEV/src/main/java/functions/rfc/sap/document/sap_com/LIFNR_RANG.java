 ...
 */
            ...
            /**
            *  LIFNR_RANG bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LIFNR_RANG
    ...
    public static class Factory{
        ...
        */
        public static LIFNR_RANG parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LIFNR_RANG object =
                new LIFNR_RANG();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"LIFNR_RANG".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LIFNR_RANG)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
