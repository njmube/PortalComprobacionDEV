 ...
 */
            ...
            /**
            *  BUKRS_RAN bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BUKRS_RAN
    ...
    public static class Factory{
        ...
        */
        public static BUKRS_RAN parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BUKRS_RAN object =
                new BUKRS_RAN();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"BUKRS_RAN".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BUKRS_RAN)functions.rfc.sap.document.sap_com.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
