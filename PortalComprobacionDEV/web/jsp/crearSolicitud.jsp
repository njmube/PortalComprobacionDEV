...
<script type="text/javascript" src="<%= URL_AppRelative %>/js/crearSolicitud.js"></script>
<style>
  ...
  <div class="navbar-inner">  	
    <div class="container" style="width: auto;">     	
      <ul class="nav" role="navigation">
        ...
        <li class="active"><a id="fat-menu" href="<%= URL_AppRelative%>/CrearSolicitud?language=${pageContext.response.locale}" role="button"><spring:message code="menu.travelform"/></a>
      </li>
