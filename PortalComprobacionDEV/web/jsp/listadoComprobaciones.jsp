...
<html>
<head>
<title>Listado de Comprobaciones</title>
...
<script type="text/javascript" src="<%= URL_AppRelative %>/js/listadoComprobaciones.js"></script>
<style>
  ...
  <div class="navbar-inner">  	
    <div class="container" style="width: auto;">     	
      <ul class="nav" role="navigation">
        <li class=""><a id="fat-menu" href="<%= URL_AppRelative%>/Inicio?language=${pageContext.response.locale}" role="button"><spring:message code="menu.advancepaymentslist"/></a>
      </li>
        ...
        <li class="active"><a id="fat-menu" href="<%= URL_AppRelative %>/ListadoComprobaciones?language=${pageContext.response.locale}" id="drop2" role="button" class=""><spring:message code="menu.expenseslist"/></a>
      </li>
...
<div id="formListaComprobacion"></div>
