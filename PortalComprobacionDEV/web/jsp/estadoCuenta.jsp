  ...
  <div class="navbar-inner">  	
    <div class="container" style="width: auto;">     	
      <ul class="nav" role="navigation">
        ...
        <li class="active"><a id="fat-menu" href="<%= URL_AppRelative %>/EstadoCuenta?language=${pageContext.response.locale}" id="drop2" role="button" class=""><spring:message code="menu.accountstatement"/></a>
      </li>
      </ul>
...
<div id="formEstadoCuenta"></div>
<div id="gridPartidaAbie"></div>
